...
class PaymentResourceIT {
    ...
    private static final PaymentType DEFAULT_TYPE = PaymentType.PERFORMANCE;
    private static final PaymentType UPDATED_TYPE = PaymentType.TRAVEL_EXPENSES;
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().type(DEFAULT_TYPE).value(DEFAULT_VALUE).description(DEFAULT_DESCRIPTION).status(DEFAULT_STATUS);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().type(UPDATED_TYPE).value(UPDATED_VALUE).description(UPDATED_DESCRIPTION).status(UPDATED_STATUS);
        return payment;
    }
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.type(UPDATED_TYPE).value(UPDATED_VALUE).description(UPDATED_DESCRIPTION).status(UPDATED_STATUS);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.type(UPDATED_TYPE).value(UPDATED_VALUE).description(UPDATED_DESCRIPTION).status(UPDATED_STATUS);
