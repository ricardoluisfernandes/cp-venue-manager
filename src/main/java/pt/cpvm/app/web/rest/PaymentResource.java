...
import pt.cpvm.app.service.PaymentService;
...
/**
 * REST controller for managing {@link pt.cpvm.app.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
public class PaymentResource {
    ...
    public ResponseEntity<List<PaymentDTO>> getAllPayments(
        ...
        if ("expense-is-null".equals(filter)) {
            log.debug("REST request to get all Payments where expense is null");
            return new ResponseEntity<>(paymentService.findAllWhereExpenseIsNull(), HttpStatus.OK);
        }
