...
export class ContractorComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.contractorService
      ...
      .subscribe({
        next: (res: HttpResponse<IContractor[]>) => {
  ...
  trackId(_index: number, item: IContractor): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IContractor[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
