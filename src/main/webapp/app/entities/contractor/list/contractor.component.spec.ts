...
describe('Contractor Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'contractor', component: ContractorComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.contractors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
