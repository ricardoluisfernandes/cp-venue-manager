...
describe('SetList Management Component', () => {
  let comp: SetListComponent;
  let fixture: ComponentFixture<SetListComponent>;
  let service: SetListService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'set-list', component: SetListComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SetListComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.setLists?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
